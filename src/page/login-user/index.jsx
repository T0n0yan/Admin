...
const LoginUser = () => {
  ...
  return (
    <div
      className="P-login-image"
      style={{ backgroundImage: `url('${state.image}')` }}
    >
      <div className="section">
        <span><p>Login: asd@gmail.com</p></span>
        <span><p>Password: asdasdasd</p></span>
        <h1
          style={{ fontSize: state.TitleSize + "px", color: state.TitleColor }}
        >
          {state.Title}
        </h1>
        <p
          style={{
            fontSize: state.DescriptionSize + "px",
